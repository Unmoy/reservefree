        ...
        <div className="row">
          <div className="col-md-6">
            ...
            <div className="doctor_detail_card">
              <div className="doc_about">
                ...
                <p>
                  {showMore ? detailText : `${detailText.substring(0, 200)}...`}
                </p>
              ...
              <div className="doc_education">
                ...
                <ul>
                  ...
                  <li>
                    State University of New York, Stony Brook, MS in Orthopedist
                    Surgery
                  </li>
                </ul>
              </div>
          ...
          <div className="col-md-6">
            <div className="booking_card">
              ...
              <BookingForm modalOpened={modalIsOpen} closeModal={closeModal} />
            </div>
          </div>
        </div>
      </div>
